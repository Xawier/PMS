<div class="container">
        <ol class="breadcrumb">
                ...
                <li class="active">Dodaj czas pracy</li>
        </ol>
</div>
        ...
        <div class="container">
                <div class="center-block">
                        <form class="form-horizontal" role="form" action="?page=ListTimeEntry" method="post">
                                <input type="hidden" name="action" value="dodaj-czas-pracy" />
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                                <input type="number" class="form-control" id="inputNumberOfHours" required="required">
                                        </div>
                                </div>
                                <div class="form-group">
