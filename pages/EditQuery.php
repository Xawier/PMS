...
<div class="container">
        <ol class="breadcrumb">
                ...
                <li class="active">Edytuj zapytanie</li>
        </ol>
</div>
        ...
        <div class="container">
                <div class="center-block">
                        <form class="form-horizontal" role="form" action="?page=ListQueries" method="post">
                                <input type="hidden" name="action" value="edytuj-zapytanie" />
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                                <input type="text" class="form-control" value="Moje zapytanie" id="inputQueryName" />
                                        </div>
                                </div>
                                <div id="kryteria">
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <label style="font-weight: normal"><input type="checkbox" checked="checked" /> Niech to zapytanie będzie zapytaniem <strong>publicznym</strong>.</label>
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label for="inputProject" class="col-sm-2 control-label">Opis <small>(opcjonalny)</small></label>
                                        <div class="col-sm-10">
                                            <textarea rows="6" class="form-control">To jest moje pierwsze zapytanie.</textarea>
                                        </div>
                                </div>
                                <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-success">Edytuj zapytanie</button>
