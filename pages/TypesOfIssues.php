		...
		<div class="container">
            ...
            <div ng-app="app" ng-controller="Ctrl">
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            <th style="width: 50%">Typ zagadnienia</th>
                            <th style="width: 20%;">Zagadnienie widoczne na mapie:</th>
                    ...
                    <tbody>
                        <tr ng-repeat="issue in issues" class="table-clickable">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>Standard fields:</strong> </p>
                                                <ul>
                                                    ...
                                                    <li>Wersja docelowa</li>
                                                    <li>Data zamknięcia</li>
                                                </ul>
                                        </div>
                            ...
                            <td>
                                <span editable-checkbox="issue.map" e-name="map" e-form="rowform" onbeforesave="checkName($data, issue.id)" >
                                {{ issue.map && "x" || "" }}
                                </span>
                            </td>
                            <td>
